...
[**auth_cli_session_create2**](AuthApi.md#auth_cli_session_create2) | **POST** /api/v1/auth/cli-session/ | 
[**auth_cli_session_retrieve**](AuthApi.md#auth_cli_session_retrieve) | **GET** /api/auth/cli-session/{session_id}/ | 
[**auth_cli_session_retrieve2**](AuthApi.md#auth_cli_session_retrieve2) | **GET** /api/v1/auth/cli-session/{session_id}/ | 
...
> models::CliSessionCreateResponse auth_cli_session_create2()
...
> models::CliSessionPollResponse auth_cli_session_retrieve2(session_id)
