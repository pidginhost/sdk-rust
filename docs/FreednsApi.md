...
> models::ActivateFreeDnsResponse freedns_dns_activate_create2(activate_free_dns)
...
> models::DnsRecordMutateResponse freedns_dns_add_record_create2(domain, source, dns_record_create)
...
> models::DeactivateFreeDnsResponse freedns_dns_deactivate_create2(deactivate_free_dns)
...
> models::DeleteRecordResponse freedns_dns_delete_record_create2(domain, source, delete_record)
...
> Vec<models::FreeDnsDomain> freedns_dns_list2()
...
> Vec<models::DnsRecord> freedns_dns_records_list2(domain, source)
