...
> models::HostingChangePasswordResponse hosting_hosting_change_password_create2(id, change_password)
...
> models::PaginatedHostingServiceList hosting_hosting_list2(page)
...
> models::HostingService hosting_hosting_retrieve2(id)
