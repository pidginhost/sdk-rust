...
[**kubernetes_clusters_eligible_vms_retrieve2**](KubernetesApi.md#kubernetes_clusters_eligible_vms_retrieve2) | **GET** /api/v1/kubernetes/clusters/{id}/eligible-vms/ | 
...
[**kubernetes_clusters_toggle_cloud_vm_access_create2**](KubernetesApi.md#kubernetes_clusters_toggle_cloud_vm_access_create2) | **POST** /api/v1/kubernetes/clusters/{id}/toggle-cloud-vm-access/ | 
...
## kubernetes_clusters_eligible_vms_retrieve2

> models::EligibleVmsResponse kubernetes_clusters_eligible_vms_retrieve2(id)
...
## kubernetes_clusters_toggle_cloud_vm_access_create2

> models::ToggleCloudVmAccessResponse kubernetes_clusters_toggle_cloud_vm_access_create2(id)
