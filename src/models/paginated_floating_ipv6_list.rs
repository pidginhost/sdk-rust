...
pub struct PaginatedFloatingIpv6List {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::FloatingIpv6>,
}

impl PaginatedFloatingIpv6List {
    pub fn new(count: i32, results: Vec<models::FloatingIpv6>) -> PaginatedFloatingIpv6List {
