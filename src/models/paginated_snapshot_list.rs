...
pub struct PaginatedSnapshotList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::Snapshot>,
}

impl PaginatedSnapshotList {
    pub fn new(count: i32, results: Vec<models::Snapshot>) -> PaginatedSnapshotList {
