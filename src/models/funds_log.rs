...
pub struct FundsLog {
    ...
    pub for_date: Option<chrono::NaiveDate>,
}

impl FundsLog {
    pub fn new(id: i32, date: String, operation: models::OperationEnum, amount: String, balance: String, for_date: Option<chrono::NaiveDate>) -> FundsLog {
        FundsLog {
            id,
            date,
            operation,
