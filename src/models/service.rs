...
impl Service {
    pub fn new(id: i32, billing_cycle: i32, hostname: String, price: String, status: models::ServiceStatusEnum, created: String, modified: String, terminated: Option<String>, next_invoice: String, primary_service: Option<i32>) -> Service {
        Service {
            id,
            company: None,
            billing_cycle,
