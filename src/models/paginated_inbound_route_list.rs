...
pub struct PaginatedInboundRouteList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::InboundRoute>,
}

impl PaginatedInboundRouteList {
    pub fn new(count: i32, results: Vec<models::InboundRoute>) -> PaginatedInboundRouteList {
