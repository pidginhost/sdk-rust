...
pub struct PaginatedDedicatedServerList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::DedicatedServer>,
}

impl PaginatedDedicatedServerList {
    pub fn new(count: i32, results: Vec<models::DedicatedServer>) -> PaginatedDedicatedServerList {
