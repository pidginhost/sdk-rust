...
pub struct PaginatedHttpRouteList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::HttpRoute>,
}

impl PaginatedHttpRouteList {
    pub fn new(count: i32, results: Vec<models::HttpRoute>) -> PaginatedHttpRouteList {
