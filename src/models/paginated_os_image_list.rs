...
pub struct PaginatedOsImageList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::OsImage>,
}

impl PaginatedOsImageList {
    pub fn new(count: i32, results: Vec<models::OsImage>) -> PaginatedOsImageList {
