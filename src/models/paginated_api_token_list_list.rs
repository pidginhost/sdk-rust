...
pub struct PaginatedApiTokenListList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ApiTokenList>,
}

impl PaginatedApiTokenListList {
    pub fn new(count: i32, results: Vec<models::ApiTokenList>) -> PaginatedApiTokenListList {
