...
pub struct FundsBalanceResponse {
...
impl FundsBalanceResponse {
    pub fn new(balance: String, threshold_type: String, threshold_amount: Option<String>, threshold_days: Option<i32>) -> FundsBalanceResponse {
