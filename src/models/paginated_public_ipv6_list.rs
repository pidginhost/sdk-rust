...
pub struct PaginatedPublicIpv6List {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PublicIpv6>,
}

impl PaginatedPublicIpv6List {
    pub fn new(count: i32, results: Vec<models::PublicIpv6>) -> PaginatedPublicIpv6List {
