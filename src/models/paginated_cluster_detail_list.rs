...
pub struct PaginatedClusterDetailList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ClusterDetail>,
}

impl PaginatedClusterDetailList {
    pub fn new(count: i32, results: Vec<models::ClusterDetail>) -> PaginatedClusterDetailList {
