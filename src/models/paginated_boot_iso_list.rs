...
pub struct PaginatedBootIsoList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::BootIso>,
}

impl PaginatedBootIsoList {
    pub fn new(count: i32, results: Vec<models::BootIso>) -> PaginatedBootIsoList {
