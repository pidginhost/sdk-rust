...
pub struct PaginatedFloatingIpv4List {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::FloatingIpv4>,
}

impl PaginatedFloatingIpv4List {
    pub fn new(count: i32, results: Vec<models::FloatingIpv4>) -> PaginatedFloatingIpv4List {
