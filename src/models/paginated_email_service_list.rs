...
pub struct PaginatedEmailServiceList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::EmailService>,
}

impl PaginatedEmailServiceList {
    pub fn new(count: i32, results: Vec<models::EmailService>) -> PaginatedEmailServiceList {
