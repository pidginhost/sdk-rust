...
pub struct PaginatedDomainRegistrantList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::DomainRegistrant>,
}

impl PaginatedDomainRegistrantList {
    pub fn new(count: i32, results: Vec<models::DomainRegistrant>) -> PaginatedDomainRegistrantList {
