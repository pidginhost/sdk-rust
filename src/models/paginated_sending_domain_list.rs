...
pub struct PaginatedSendingDomainList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::SendingDomain>,
}

impl PaginatedSendingDomainList {
    pub fn new(count: i32, results: Vec<models::SendingDomain>) -> PaginatedSendingDomainList {
