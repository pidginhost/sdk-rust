...
pub struct PaginatedDnsGlueList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::DnsGlue>,
}

impl PaginatedDnsGlueList {
    pub fn new(count: i32, results: Vec<models::DnsGlue>) -> PaginatedDnsGlueList {
