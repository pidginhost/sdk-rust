...
impl TicketDetail {
    pub fn new(id: i32, subject: String, department: models::Department, priority: models::Priority3cdEnum, status: models::StatusEf2Enum, created: String, updated: String, messages: String) -> TicketDetail {
        TicketDetail {
            id,
            subject,
