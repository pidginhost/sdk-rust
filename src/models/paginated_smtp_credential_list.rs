...
pub struct PaginatedSmtpCredentialList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::SmtpCredential>,
}

impl PaginatedSmtpCredentialList {
    pub fn new(count: i32, results: Vec<models::SmtpCredential>) -> PaginatedSmtpCredentialList {
