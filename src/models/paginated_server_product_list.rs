...
pub struct PaginatedServerProductList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ServerProduct>,
}

impl PaginatedServerProductList {
    pub fn new(count: i32, results: Vec<models::ServerProduct>) -> PaginatedServerProductList {
