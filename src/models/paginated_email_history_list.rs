...
pub struct PaginatedEmailHistoryList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::EmailHistory>,
}

impl PaginatedEmailHistoryList {
    pub fn new(count: i32, results: Vec<models::EmailHistory>) -> PaginatedEmailHistoryList {
