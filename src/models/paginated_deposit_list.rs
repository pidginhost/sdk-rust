...
pub struct PaginatedDepositList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::Deposit>,
}

impl PaginatedDepositList {
    pub fn new(count: i32, results: Vec<models::Deposit>) -> PaginatedDepositList {
