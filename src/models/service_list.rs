...
impl ServiceList {
    pub fn new(id: i32, hostname: String, status: models::ServiceStatusEnum, price: String, next_invoice: String, created: String, billing_cycle: String, auto_payment: bool, company: Option<models::ServiceCompany>) -> ServiceList {
        ServiceList {
            id,
            hostname,
            status,
