...
pub struct ServiceList {
    ...
    pub company: Option<Box<models::ServiceCompany>>,
}

impl ServiceList {
    pub fn new(id: i32, hostname: String, status: models::ServiceStatusEnum, price: String, next_invoice: chrono::NaiveDate, created: String, billing_cycle: String, auto_payment: bool, company: Option<models::ServiceCompany>) -> ServiceList {
        ServiceList {
            id,
            hostname,
            status,
            ...
            billing_cycle,
            auto_payment,
            company: if let Some(x) = company {Some(Box::new(x))} else {None},
        }
    }
}
