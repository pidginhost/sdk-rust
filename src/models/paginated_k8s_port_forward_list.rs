...
pub struct PaginatedK8sPortForwardList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::K8sPortForward>,
}

impl PaginatedK8sPortForwardList {
    pub fn new(count: i32, results: Vec<models::K8sPortForward>) -> PaginatedK8sPortForwardList {
