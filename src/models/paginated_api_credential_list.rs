...
pub struct PaginatedApiCredentialList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ApiCredential>,
}

impl PaginatedApiCredentialList {
    pub fn new(count: i32, results: Vec<models::ApiCredential>) -> PaginatedApiCredentialList {
