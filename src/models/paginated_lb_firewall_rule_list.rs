...
pub struct PaginatedLbFirewallRuleList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::LbFirewallRule>,
}

impl PaginatedLbFirewallRuleList {
    pub fn new(count: i32, results: Vec<models::LbFirewallRule>) -> PaginatedLbFirewallRuleList {
