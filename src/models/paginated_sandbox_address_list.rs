...
pub struct PaginatedSandboxAddressList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::SandboxAddress>,
}

impl PaginatedSandboxAddressList {
    pub fn new(count: i32, results: Vec<models::SandboxAddress>) -> PaginatedSandboxAddressList {
