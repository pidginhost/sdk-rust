...
impl UdpRoute {
    ...
    pub fn new(id: i32, name: String, port: i32, backend_service_name: String, backend_service_port: i32, status_ready: Option<bool>, status_message: String, created: String, updated: String) -> UdpRoute {
        UdpRoute {
            id,
            name,
            namespace: None,
