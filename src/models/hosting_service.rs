...
impl HostingService {
    ...
    pub fn new(id: i32, hostname: String, status: models::ServiceStatusEnum, price: String, next_invoice: String, created: String, billing_cycle: String, package_name: String, node_url: String, username: String) -> HostingService {
        HostingService {
            id,
            hostname,
            status,
