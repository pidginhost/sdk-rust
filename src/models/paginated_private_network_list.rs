...
pub struct PaginatedPrivateNetworkList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PrivateNetwork>,
}

impl PaginatedPrivateNetworkList {
    pub fn new(count: i32, results: Vec<models::PrivateNetwork>) -> PaginatedPrivateNetworkList {
