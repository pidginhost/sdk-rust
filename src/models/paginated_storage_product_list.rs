...
pub struct PaginatedStorageProductList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::StorageProduct>,
}

impl PaginatedStorageProductList {
    pub fn new(count: i32, results: Vec<models::StorageProduct>) -> PaginatedStorageProductList {
