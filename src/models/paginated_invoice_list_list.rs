...
pub struct PaginatedInvoiceListList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::InvoiceList>,
}

impl PaginatedInvoiceListList {
    pub fn new(count: i32, results: Vec<models::InvoiceList>) -> PaginatedInvoiceListList {
