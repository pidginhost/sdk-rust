...
pub struct ClusterDetail {
    ...
    pub storage_quota_gb: String,
    #[serde(rename = "last_pool_used_bytes")]
    pub last_pool_used_bytes: String,
    #[serde(rename = "last_storage_sync_at")]
    pub last_storage_sync_at: String,
}

impl ClusterDetail {
    pub fn new(id: i32, status: models::StatusA57Enum, generation: String, cluster_type: String, kube_version: String, price_per_month: String, price_per_hour: String, features_ready: bool, kubeconfig_valid_until: String, ipv4_address: String, ipv6_address: String, dual_stack: String, talos_version: String, talos_upgrade_available: String, talos_next_version: String, storage_quota_gb: String, last_pool_used_bytes: String, last_storage_sync_at: String) -> ClusterDetail {
        ClusterDetail {
            id,
            status,
            name: None,
