...
pub struct PowerManagementRequest {
    #[serde(rename = "action")]
    pub action: models::PowerManagementRequestActionEnum,
}

impl PowerManagementRequest {
    pub fn new(action: models::PowerManagementRequestActionEnum) -> PowerManagementRequest {
