...
pub struct PaginatedFloatingIpAuthorizationList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::FloatingIpAuthorization>,
}

impl PaginatedFloatingIpAuthorizationList {
    pub fn new(count: i32, results: Vec<models::FloatingIpAuthorization>) -> PaginatedFloatingIpAuthorizationList {
