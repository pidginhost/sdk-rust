...
pub struct PaginatedUdpRouteList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::UdpRoute>,
}

impl PaginatedUdpRouteList {
    pub fn new(count: i32, results: Vec<models::UdpRoute>) -> PaginatedUdpRouteList {
