...
pub struct ChangeBillingCycle {
    #[serde(rename = "billing_cycle_id")]
    pub billing_cycle_id: i32,
}

impl ChangeBillingCycle {
    pub fn new(billing_cycle_id: i32) -> ChangeBillingCycle {
        ChangeBillingCycle {
            billing_cycle_id,
        }
    }
