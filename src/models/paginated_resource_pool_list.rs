...
pub struct PaginatedResourcePoolList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ResourcePool>,
}

impl PaginatedResourcePoolList {
    pub fn new(count: i32, results: Vec<models::ResourcePool>) -> PaginatedResourcePoolList {
