...
impl Server {
    pub fn new(id: i32, image: String, package: String, cpus: i32, memory: i32, disk_size: i32, generation: String, destroy_protection: bool, ha_enabled: bool, networks: std::collections::HashMap<String, serde_json::Value>) -> Server {
        Server {
            id,
            hostname: None,
            project: None,
