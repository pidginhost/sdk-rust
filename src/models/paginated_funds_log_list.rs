...
pub struct PaginatedFundsLogList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::FundsLog>,
}

impl PaginatedFundsLogList {
    pub fn new(count: i32, results: Vec<models::FundsLog>) -> PaginatedFundsLogList {
