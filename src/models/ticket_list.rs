...
impl TicketList {
    pub fn new(id: i32, subject: String, department: String, priority: models::TicketPriorityEnum, status: models::TicketStatusEnum, created: String, updated: String) -> TicketList {
        TicketList {
            id,
            subject,
            department,
