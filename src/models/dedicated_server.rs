...
impl DedicatedServer {
    ...
    pub fn new(id: i32, hostname: String, status: models::ServiceStatusEnum, price: String, next_invoice: String, created: String, billing_cycle: String, server_status: String, ips: String, os_name: String) -> DedicatedServer {
        DedicatedServer {
            id,
            hostname,
            status,
