...
pub struct PaginatedTcpRouteList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::TcpRoute>,
}

impl PaginatedTcpRouteList {
    pub fn new(count: i32, results: Vec<models::TcpRoute>) -> PaginatedTcpRouteList {
