...
pub struct PaginatedPublicIpv4List {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PublicIpv4>,
}

impl PaginatedPublicIpv4List {
    pub fn new(count: i32, results: Vec<models::PublicIpv4>) -> PaginatedPublicIpv4List {
