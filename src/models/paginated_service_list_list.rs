...
pub struct PaginatedServiceListList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ServiceList>,
}

impl PaginatedServiceListList {
    pub fn new(count: i32, results: Vec<models::ServiceList>) -> PaginatedServiceListList {
