...
pub struct PaginatedHostingServiceList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::HostingService>,
}

impl PaginatedHostingServiceList {
    pub fn new(count: i32, results: Vec<models::HostingService>) -> PaginatedHostingServiceList {
