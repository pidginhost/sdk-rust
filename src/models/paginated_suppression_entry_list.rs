...
pub struct PaginatedSuppressionEntryList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::SuppressionEntry>,
}

impl PaginatedSuppressionEntryList {
    pub fn new(count: i32, results: Vec<models::SuppressionEntry>) -> PaginatedSuppressionEntryList {
