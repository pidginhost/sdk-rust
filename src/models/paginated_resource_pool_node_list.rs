...
pub struct PaginatedResourcePoolNodeList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ResourcePoolNode>,
}

impl PaginatedResourcePoolNodeList {
    pub fn new(count: i32, results: Vec<models::ResourcePoolNode>) -> PaginatedResourcePoolNodeList {
