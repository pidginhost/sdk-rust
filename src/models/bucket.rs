...
impl Bucket {
    pub fn new(id: i32, name: String, full_name: String, quota_gb: i32, used_bytes: i32, object_count: i32, public_read: bool, status: models::ResourceStatusEnum, endpoint: String, region: String, created: String) -> Bucket {
        Bucket {
            id,
            name,
            full_name,
