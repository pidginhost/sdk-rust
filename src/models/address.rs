...
pub struct Address {
    ...
    #[serde(rename = "region_fk", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub region_fk: Option<Option<i32>>,
    #[serde(rename = "locality_fk", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub locality_fk: Option<Option<i32>>,
}

impl Address {
    pub fn new(id: i32, country: models::CountryEnum) -> Address {
        Address {
            id,
            country,
            city: None,
