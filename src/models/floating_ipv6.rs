...
impl FloatingIpv6 {
    pub fn new(id: i32, address: String, gateway: String, prefix: i32, reverse_dns: String, authorized_vm_count: i32, created_at: String) -> FloatingIpv6 {
        FloatingIpv6 {
            id,
            address,
            gateway,
